 ...
 */
public class ConvertCurrencyFragment<mContext> extends Fragment implements SearchView.OnQueryTextListener
{
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.currency_search_menu, menu);
        MenuItem searchItem = menu.findItem(R.id.search_currency);
