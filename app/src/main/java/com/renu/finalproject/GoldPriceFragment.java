...
public class GoldPriceFragment extends Fragment implements SearchView.OnQueryTextListener
{
     ...
     * @return A new instance of fragment GoldPrice.
     */
    // TODO: Rename and change types and number of parameters
    public static GoldPriceFragment newInstance(String param1, String param2)
    {
    ...
    {
        inflater.inflate(R.menu.gold_search_menu, menu);
        MenuItem searchItem = menu.findItem(R.id.search_gold);
